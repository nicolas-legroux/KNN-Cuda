...
void gpu_knn_quicksort_benchmark(double *train_data, double *test_data, int *train_labels,
...
void gpu_knn_extract_minimums_benchmark(double *train_data, double *test_data, int *train_labels,
		int n_train, int n_test, int n_labels, int dim, int k, int* knn_labels) {
	clock_t start = clock();
